#!/usr/bin/env python3
# Run:
# uv run python packages/nexagauge-graph/test_ng_graph/run_sample_graph_example.py
...
from ng_core.types import MetricCategory, MetricResult  # noqa: F401 – used by fake nodes
...
def _run_mocked_graph_eval() -> None:
    ...
    builtins.Path = Path
    try:
        graph = importlib.import_module("ng_graph.graph")
    finally:
