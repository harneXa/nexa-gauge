...
# uv run pytest -s packages/nexagauge-graph/test_ng_graph/test_nodes/test_dedup.py::test_run_returns_dedup_artifacts_from_mocked_deduplicate
# uv run pytest -s -k "dedup" packages/nexagauge-graph/test_ng_graph/test_nodes/test_dedup.py

import pytest
from ng_core.types import Item
from ng_graph.nodes import dedup as dedup_module
from ng_graph.nodes.dedup import DedupNode
