# Debug commands:
# uv run pytest -s packages/nexagauge-graph/test_ng_graph/test_nodes/test_chunk_extractor.py
# uv run pytest -s packages/nexagauge-graph/test_ng_graph/test_nodes/test_chunk_extractor.py::test_run_returns_single_chunk_for_short_input
# uv run pytest -s -k "chunk_extractor" packages/nexagauge-graph/test_ng_graph/test_nodes/test_chunk_extractor.py

from ng_core.types import Item
from ng_graph.nodes.chunk_extractor import ChunkExtractorNode
