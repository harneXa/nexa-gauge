...
Function objects are NOT stored here — they live in lumis-graph so this
module can be imported by lumis-core, lumis-ingest, lumis-graph,
and lumis-cli without creating circular imports.
"""
...
#   2. Add one entry to NODE_FNS in lumis_graph/registry.py.
#   3. Write the node function in lumis_graph/nodes/metrics/<name>.py.
#   4. Add g.add_edge() calls in lumis_graph/graph.py build_graph().
