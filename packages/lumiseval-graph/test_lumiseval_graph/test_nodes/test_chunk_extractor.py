# Debug commands:
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_chunk_extractor.py
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_chunk_extractor.py::test_run_returns_single_chunk_for_short_input
# uv run pytest -s -k "chunk_extractor" packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_chunk_extractor.py

from lumiseval_core.types import Item
from lumiseval_graph.nodes.chunk_extractor import ChunkExtractorNode
