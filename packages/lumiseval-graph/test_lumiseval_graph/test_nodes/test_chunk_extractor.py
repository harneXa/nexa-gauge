# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_chunk_extractor.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_chunk_extractor.py::test_run_returns_single_chunk_for_short_input
# uv run pytest -s -k "chunk_extractor" packages/lumis-graph/test_lumis_graph/test_nodes/test_chunk_extractor.py
