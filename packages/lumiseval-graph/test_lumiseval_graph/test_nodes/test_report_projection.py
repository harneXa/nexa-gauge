...
def test_extract_path_scalar() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_extract_path_scalar
    """
...
def test_extract_path_list_wildcard() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_extract_path_list_wildcard
    """
    data = {
        "claims": [
...
def test_extract_path_missing_returns_nullish_defaults() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_extract_path_missing_returns_nullish_defaults
    """
    data = {"claims": None}
...
def test_resolve_path_scalar_from_state() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_path_scalar_from_state
    """
...
def test_resolve_path_nested_pydantic() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_path_nested_pydantic
    """
    state = {
        "inputs": Inputs(
            case_id="case-1",
...
def test_resolve_path_none_intermediate() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_path_none_intermediate
    """
    state = {"inputs": None}
...
def test_resolve_path_wildcard_on_pydantic() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_path_wildcard_on_pydantic
    """
    state = {
...
def test_resolve_section_string_spec() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_section_string_spec
    """
...
def test_resolve_section_nested_dict_spec() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_projection.py::test_resolve_section_nested_dict_spec
    """
    state = {
        "target_node": "eval",
        "inputs": Inputs(
