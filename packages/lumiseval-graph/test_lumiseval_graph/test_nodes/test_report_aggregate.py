...
def test_only_grounding() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_only_grounding
    """
    state = _make_state(
...
def test_only_relevance() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_only_relevance
    """
    state = _make_state(
        generation_chunk=_chunks(),
        generation_claims=_claims(),
...
def test_only_geval() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_only_geval
    """
    state = _make_state(
...
def test_only_redteam() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_only_redteam
    """
    state = _make_state(
...
def test_grounding_and_relevance() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_grounding_and_relevance
    """
    state = _make_state(
        generation_chunk=_chunks(),
        generation_claims=_claims(),
...
def test_full_eval() -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_report_aggregate.py::test_full_eval
    """
    state = _make_state(
        generation_chunk=_chunks(),
        generation_claims=_claims(),
