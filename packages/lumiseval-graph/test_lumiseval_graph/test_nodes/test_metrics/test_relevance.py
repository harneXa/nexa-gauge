# Debug commands:
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_relevance.py
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_relevance.py::test_run_returns_metric_and_cost_with_mocked_llm
# uv run pytest -s -k "relevance" packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_relevance.py
