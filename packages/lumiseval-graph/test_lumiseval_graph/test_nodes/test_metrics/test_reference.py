# Debug commands:
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_reference.py
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_reference.py::test_run_returns_reference_metrics_for_item_inputs
# uv run pytest -s -k "reference" packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_reference.py
