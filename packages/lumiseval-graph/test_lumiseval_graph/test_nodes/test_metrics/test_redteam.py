# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_redteam.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_redteam.py::test_run_uses_default_bias_and_toxicity_metrics
# uv run pytest -s -k "redteam" packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_redteam.py
