# Debug commands:
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_steps.py
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_steps.py::test_run_uses_cache_without_llm_call
# uv run pytest -s -k "geval and steps" packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_steps.py
