# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_geval/test_steps.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_geval/test_steps.py::test_run_uses_cache_without_llm_call
# uv run pytest -s -k "geval and steps" packages/lumis-graph/test_lumis_graph/test_nodes/test_metrics/test_geval/test_steps.py
