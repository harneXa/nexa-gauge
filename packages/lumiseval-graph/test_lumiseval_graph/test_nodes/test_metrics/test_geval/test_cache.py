# Debug commands:
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_cache.py
# uv run pytest -s packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_cache.py::test_collect_geval_signatures_deduplicates_and_skips_preprovided_steps
# uv run pytest -s -k "geval and cache" packages/lumiseval-graph/test_lumiseval_graph/test_nodes/test_metrics/test_geval/test_cache.py
