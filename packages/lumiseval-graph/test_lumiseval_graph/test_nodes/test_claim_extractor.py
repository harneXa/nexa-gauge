# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_claim_extractor.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_claim_extractor.py::test_run_builds_claim_artifacts_with_mocked_llm
# uv run pytest -s -k "claim_extractor" packages/lumis-graph/test_lumis_graph/test_nodes/test_claim_extractor.py
