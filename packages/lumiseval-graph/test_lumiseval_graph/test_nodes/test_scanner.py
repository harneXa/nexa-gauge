# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_scanner.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_nodes/test_scanner.py::test_scan_builds_inputs_with_primary_keys
# uv run pytest -s -k "scanner" packages/lumis-graph/test_lumis_graph/test_nodes/test_scanner.py
