# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_llm_routing.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_llm_routing.py::test_node_generation_claims_uses_canonical_model_key
# uv run pytest -s -k "llm_routing" packages/lumis-graph/test_lumis_graph/test_graph/test_llm_routing.py
