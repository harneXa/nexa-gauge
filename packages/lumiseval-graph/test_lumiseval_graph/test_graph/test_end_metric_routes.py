# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_report_for_metric_targets_contains_only_that_branch
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_report_for_eval_contains_all_metric_branches
...
def test_report_for_metric_targets_contains_only_that_branch(
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_report_for_metric_targets_contains_only_that_branch
    """
...
def test_report_for_eval_contains_all_metric_branches(
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_report_for_eval_contains_all_metric_branches
    """
    state = {
        "target_node": "eval",
        "job_id": "job-eval",
...
def test_node_eval_is_orchestration_only(graph_module) -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_node_eval_is_orchestration_only
    """
...
def test_report_for_grounding_target_includes_inputs_and_branch_nodes(graph_module) -> None:
    ...
    Run: uv run pytest -s packages/lumis-graph/test_lumis_graph/test_graph/test_end_metric_routes.py::test_report_for_grounding_target_includes_inputs_and_branch_nodes
    """
    state = {
