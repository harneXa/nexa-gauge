# Debug commands:
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_llm/test_gateway.py
# uv run pytest -s packages/lumis-graph/test_lumis_graph/test_llm/test_gateway.py::test_get_llm_cache_key_changes_with_runtime_override
# uv run pytest -s -k "llm and gateway" packages/lumis-graph/test_lumis_graph/test_llm/test_gateway.py
