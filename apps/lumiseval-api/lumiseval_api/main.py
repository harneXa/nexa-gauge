...
from lumiseval_api.adapters import create_dataset_adapter
...
app = typer.Typer(name="lumis", help="Agentic LLM evaluation pipeline.")
...
def run(*args: Any, **kwargs: Any) -> None:
    ...
    import lumiseval_api.cli.run as run_module
...
def estimate(*args: Any, **kwargs: Any) -> None:
    """Backward-compatible callable used by tests and programmatic callers."""
    import lumiseval_api.cli.estimate as estimate_module
